...
public class MortgageActivity extends AppCompatActivity implements OnClickListener,
    ...
    private double[] businessArray = {3.60, 3.85, 3.95, 3.95, 4.20, 4.65, 4.90, 5.15, 5.40, 5.65, 5.90, 6.15, 6.55};
    private double[] accumulationArray = {2.85, 2.85, 2.85, 3.10, 3.10, 3.10, 3.25, 3.25, 3.50, 3.75, 4.00, 4.25, 4.50};
